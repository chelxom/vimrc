...
syn keyword mlirOps getTensor index_cast load memref_cast memref_shape_cast mulf muli
syn keyword mlirOps prefetch sitofp splat store select subf subi subview tensor_cast view
